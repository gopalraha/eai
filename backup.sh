...
sudo tar -xzvf velero-v1.6.0-linux-amd64.tar.gz 

sudo cp -arv ./velero-v1.6.0-linux-amd64/velero /usr/local/bin/
sudo cp -arv ./velero-v1.6.0-linux-amd64/velero /bin/
